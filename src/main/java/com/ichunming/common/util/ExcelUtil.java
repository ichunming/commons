...
import com.ichunming.common.helper.ExcelException;
...
public class ExcelUtil {
	...
	public static <T> List<T> convertToList(Class<T> clz) throws ExcelException {
		...
		for(int rownum = rowFrom; rownum <= rowTo; rownum++) {
			...
			if(null == obj) {
				// convert fail
				System.out.println("convert fail[rownum:" + rownum + "]");
			}
			// add to list
			result.add(obj);
		}
		
		System.out.println("success to convert excel file to object list");
		return result;
	}
	...
	public static <T> T convertToObj(Class<T> clz, int rownum) throws ExcelException {
		...
		try {
			...
			System.out.println("fail to convert excel record to object.");
			e.printStackTrace();
			throw new ExcelException(e);
		}
		
		System.out.println("success to convert excel file to object");
		return obj;
	}
